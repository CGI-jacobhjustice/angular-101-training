...
module.exports = "<hello name=\"{{ name }}\"></hello>\r\n<button (click)=\"addAssetDemo()\">Add Asset</button>\r\n<h1>Assets:</h1>\r\n<div *ngIf=\"assets\">\r\n  <ul >\r\n    <li *ngFor=\"let a of assets\">\r\n      <b>Tag ID:</b> {{a.assetTagId}}, <b>Asset Type:</b> {{a.assetType}}, <b>Description:</b> {{a.description}}, <b>Date Added:</b> {{a.dateAdded.toLocaleString()}}, <b>Assigned To:</b> {{a.assignedTo}}, <b>retired:</b> {{a.retired}}\r\n    </li>\r\n  </ul>\r\n</div>"
...
var hello_component_1 = __webpack_require__(/*! ./hello/hello.component */ "./src/app/hello/hello.component.ts");
var routes = [
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            providers: [asset_service_1.AssetService, mock_backend_1.mockBackendProvider]
        })
    ], AppModule);
    return AppModule;
}());
